...
from light_unet_dct_selective import LiteUNetSelectiveDCT
...
from light_unet_dct_selective_optional_compression import LiteUNetSelectiveDCT
...
# ================================================================
class HParams:
    train_path = r"C:\Users\DELLAURORA\Desktop\Yingyi\HT_wildfire\wildfire_detection_hadamard_transform\archive\next_day_wildfire_spread_train_*.tfrecord" ## data path
    eval_path  = r"C:\Users\DELLAURORA\Desktop\Yingyi\HT_wildfire\wildfire_detection_hadamard_transform\archive\next_day_wildfire_spread_eval_*.tfrecord"
    test_path  = r"C:\Users\DELLAURORA\Desktop\Yingyi\HT_wildfire\wildfire_detection_hadamard_transform\archive\next_day_wildfire_spread_test_*.tfrecord"
    ...
    compression_ratio = 1.0           # 1.0 = no compression; 0.5 = keep 50% low-freq block
    threshold_mode = "soft"           # "soft" or "hard"
    learnable_transform = False       # learnable DCT matrices? (usually keep False)
...
# >>> NEW: import your selective WHT UNet <<<
from light_unet_wht_selective import LiteUNetSelectiveWHT


EXPERIMENT_ROOT = "gaussian_sweep_results_DCT_Unet_ablation_layer5"
...
for profile in ["fine"]:
    for combine_mode in COMBINE_MODES:
        ...
        model = LiteUNetSelectiveDCT(
            ...
            base_c=4,
            use_dct=hp.use_dct,
            compression_ratio=hp.compression_ratio,    # 1.0 disables compression
